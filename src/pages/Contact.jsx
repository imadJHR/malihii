...
const Contact = () => {
  return (
   <div className="py-36">
    <div className="flex items-center justify-center bg-gray-200 w-96 mx-auto rounded-full">
        <img src="https://arabiiandeals.com/wp-content/uploads/2024/10/متجر-العرب-2.png" alt="" />
    </div>
